# 2. Ameaças e Vulnerabilidades no Ecossistema Digital

No ecossistema de segurança, o risco é gerado quando uma **Ameaça** explora uma **Vulnerabilidade** ativa de um sistema.

## Principais Ameaças Digitais

1. **Phishing:** Engenharia social baseada em mensagens fraudulentas que mimetizam marcas legítimas (ex: e-mails de bancos falsos) para induzir a vítima a revelar credenciais ou clicar em links maliciosos.
2. **Malware:** Softwares maliciosos (vírus, cavalos de troia, ransomware) projetados para infiltrar, danificar ou sequestrar dados e sistemas.
3. **Engenharia Social:** Manipulação psicológica de pessoas para que executem ações ou divulguem informações confidenciais de forma voluntária, mas induzida.

## Matriz de Vulnerabilidades

| Tipo de Vulnerabilidade | Descrição Prática | Impacto Potencial |
| :--- | :--- | :--- |
